...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  protected Map<Class<?>, List<Class<?>>> getRequiredTypeConverters() {
    ...
    _typeConvertersMap.put(ProductDao.class, ProductDao_AppDatabase_1_Impl.getRequiredConverters());
    _typeConvertersMap.put(CartDao.class, CartDao_AppDatabase_1_Impl.getRequiredConverters());
    _typeConvertersMap.put(OrderDao.class, OrderDao_AppDatabase_1_Impl.getRequiredConverters());
  ...
  public ProductDao productDao() {
    if (_productDao != null) {
      ...
      synchronized(this) {
        if(_productDao == null) {
          _productDao = new ProductDao_AppDatabase_1_Impl(this);
        }
        return _productDao;
      }
    }
  ...
  public CartDao cartDao() {
    if (_cartDao != null) {
      ...
      synchronized(this) {
        if(_cartDao == null) {
          _cartDao = new CartDao_AppDatabase_1_Impl(this);
        }
        return _cartDao;
      }
    }
  ...
  public OrderDao orderDao() {
    if (_orderDao != null) {
      ...
      synchronized(this) {
        if(_orderDao == null) {
          _orderDao = new OrderDao_AppDatabase_1_Impl(this);
        }
        return _orderDao;
      }
    }
